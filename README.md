...
|---|---|---|---|
| Command output | 236 parsers in all, 19 of them streaming; named, or taken from the command name | no | 746 definitions under 271 names; detected from the text, generic formats need `--parser` |
