...
|---|---|---|---|
| Command output | 236 parsers in all, 19 of them streaming; named, or taken from the command name | no | 743 definitions under 270 names; detected from the text, generic formats need `--parser` |
