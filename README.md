...
| | jc 1.25.7 | jo 1.9 | jz v0.7.1 |
|---|---|---|---|
| Command output | 236 parsers in all, 19 of them streaming; named, or taken from the command name | no | 742 definitions under 270 names; detected from the text, generic formats need `--parser` |
