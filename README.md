...
|---|---|---|---|
| Command output | 236 parsers in all, 19 of them streaming; named, or taken from the command name | no | 753 definitions under 277 names; detected from the text, generic formats need `--parser` |
